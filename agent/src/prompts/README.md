...
- `audit` — adversarial second-opinion pass by a separately configured model (`agent/config/models.yaml`); the auditor **fixes the artifact directly** — its revised output replaces the draft.
...
| File | Stage | Role |
|---|---|---|
| `app_discovery_draft.md` / `app_discovery_audit.md` | app-discovery | classify repo, find startable apps |
| `brownfield_baseline_draft.md` / `brownfield_baseline_audit.md` | brownfield-baseline | pre-existing system baseline |
| `tech_stack_draft.md` / `tech_stack_audit.md` | tech-stack | detect languages/frameworks |
| `raw_requirements_draft.md` / `raw_requirements_audit.md` | raw-requirements | rough notes → requirements doc |
...
| `adversarial_audit_draft.md` / `adversarial_audit_audit.md` | adversarial-audit | adversarial code audit |
| `dedup_draft.md` / `dedup_audit.md` | dedup-simplify | duplication removal |
...
| `license_audit_draft.md` / `license_audit_audit.md` | license-audit | license compliance |
...
| `exit_draft.md` / `exit_audit.md` | exit | final summary/changelog |
