...
If the application has not been scaffolded yet (no repository layout beyond
`.ai-dev-workflow/`), your plan's first Plan Step must be the scaffold step described above --
never skip straight to feature work as if the code already existed.
