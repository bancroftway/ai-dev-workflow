...
flowchart TD
    ...
    failed(["RUN FAILURE — END<br/>Any exhausted retry cap or lost sandbox ends the run here:<br/>ledger row written, committed and pushed; run_failure streamed to the UI.<br/>Counters reset in the same step, so resubmitting starts a clean attempt."])
...
<!-- graph-source-sha256: 04eb22a1eeabe6e1df267090c0e31d09adfbe2d18939c871e0c87ef05751194a -->
